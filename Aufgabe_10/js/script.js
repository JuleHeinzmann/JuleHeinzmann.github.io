...
function drawListToDOM() {
    ...
    var _loop_1 = function (index_1) {
         ...
         */
        todo.innerHTML = "<span class='check " + TodoObj.todosChecked[index_1] + "'><i class='fas fa-check'></i></span>"
            + TodoObj.todosText[index_1] +
    ...
    for (var index_1 = 0; index_1 < TodoObj.todosText.length; index_1++) {
        _loop_1(index_1);
    }
    updateCounter();
}
function updateCounter() {
    var done = 0;
    var notdone = 0;
    for (var i = 0; i < TodoObj.todosChecked.length; i++) {
